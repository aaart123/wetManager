...
class TokenModel extends AppModel
{
    ...
    public function setToken($openId, $access_token, $refresh_token)
    {
        ...
        {
            return $this->where(array('openid'=>$openId))->save(array('access_token'=>$access_token,'refresh_token'=>$refresh_token,'timestamp'=>time()));
        }else{
            return $this->add(array('openid'=>$openId,'access_token'=>$access_token,'refresh_token'=>$refresh_token,'timestamp'=>time()));
        }
